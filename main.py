...
def main():
   ##  PART 1: ETL  ##
    ...
    directories = ['data/part2_plots', 'data/part3_plots', 'data/part4_plots', 'data/part5_plots'] part1.create_directories(directories)  
  ...
  ##  PART 2: PLOT EXAMPLES  ## 
   # Apply plot theme
    ...
    part3.bar_plot(charge_counts)  part3.histogram(pred_universe['some_numeric_column'])  
   ...
   ##  PART 4: CATEGORICAL PLOTS  ## 
    part4.count_plot(charge_counts)  part4.box_plot(pred_universe, category='category_column', value='numeric_value_column') 
